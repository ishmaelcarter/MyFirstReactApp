...
var TodoApp = React.createClass({
  ...
  return {user: ['Ishmael Carter', 'Riley Cooper'], items: ['Task 1', 
  'Task 2'], 
  completedItems: ['DID']};
  },
...
var TopHeader = React.createClass({
  render: function(){
    return(
      <div>
      <h1 className="TopHeader">ToDo</h1>
      <img src="newuser.png" alt="NewUser" className="UserPhoto"></img>
      <p className="user"><a>Username</a></p>
      </div>
      )
  }
})
